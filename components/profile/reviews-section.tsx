  ...
  return (
    <section>
      <div className="flex items-center gap-4 mb-6 border-b border-border pb-4">
        ...
        {reviews.length > 0 && (
          <div className="flex items-center gap-3 ml-auto bg-background border border-border px-4 py-1.5 rounded-full">
      ...
      {reviews.length > 0 ? (
        <div className="space-y-6">
          {reviews.map((review) => (
            <div key={review.id} className="bg-background border border-border p-5 rounded-[var(--radius-card)] shadow-subtle flex flex-col sm:flex-row gap-5">
