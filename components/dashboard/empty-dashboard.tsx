...
import { Sparkles, ArrowRight, UserCheck, Search, MessageSquarePlus, RefreshCcw, ShieldCheck, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-500">
        ...
        <div className="mt-12 max-w-2xl mx-auto text-center">
          <div className="w-24 h-24 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-6 relative">
          ...
          <h2 className="text-3xl font-bold text-heading">Welcome to Weave</h2>
          <p className="text-lg text-body mt-4">
          ...
          <div className="mt-10 bg-surface border border-border rounded-[var(--radius-card)] p-6 md:p-8 text-left shadow-subtle">
            <h3 className="font-bold text-heading uppercase text-xs tracking-wider mb-6">Getting Started Checklist</h3>
                ...
                <Link 
                  ...
                  className={`flex items-start gap-4 p-4 rounded-xl border transition-all ${
                    step.done 
                      ...
                      : 'bg-background border-border hover:border-primary/50 group'
                  }`}
                >
            ...
            <div className="mt-8 pt-6 border-t border-border flex justify-center">
              <Link 
                href="/marketplace"
                className="px-6 py-3 bg-primary text-primary-foreground font-bold rounded-[var(--radius-button)] shadow-glow hover:bg-primary/90 transition-all flex items-center gap-2"
              >
