        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="pt-6 border-t border-border flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-8 py-3 bg-primary text-background font-bold rounded-[var(--radius-button)] hover:bg-primary-hover transition-colors disabled:opacity-50 flex items-center justify-center gap-2 min-w-[150px]"
            >
              {isSubmitting ? (
